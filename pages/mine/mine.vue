			...
			<view class="menu_list">
				<view class="menu_list_block">
					<u-cell-group>
						...
						<u-cell-item title="邀请朋友" :title-style="menuListTitleStyle" :border-bottom="false"
							@click="routeQr">
				...
				<view class="menu_list_block">
					<u-cell-group>
						<u-cell-item title="收货地址" :title-style="menuListTitleStyle" :border-bottom="false"
							@click="routeAddress">
							<u-icon name="/static/icon/mine-menu3@2x.png" slot="icon" size="40"></u-icon>
						</u-cell-item>
						<u-cell-item title="关于我们" :title-style="menuListTitleStyle" :border-bottom="false"
							@click="routeAbout">
							<u-icon name="/static/icon/mine-menu4@2x.png" slot="icon" size="40"></u-icon>
						</u-cell-item>
						<u-cell-item title="平台客服" :title-style="menuListTitleStyle" :border-bottom="false"
							@click="routeContact">
				...
				<view class="menu_list_block">
					<u-cell-group>
						<u-cell-item title="设置" :title-style="menuListTitleStyle" :border-bottom="false"
							@click="routeSetting">
