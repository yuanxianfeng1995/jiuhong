<template>
	<view>
		...
		<!-- 广告图 -->
		<view class="banner"><image src="/static/image/banner1.jpg"></image></view>
		<!-- 活动区 -->
		...
		<view class="goods-list">
			<view class="title">
				<image src="/static/image/hua.png"></image>
				猜你喜欢
				<image src="/static/image/hua.png"></image>
			</view>
...
export default {
	data() {
		return {
			...
			// 轮播图片
			swiperList: [
				{ id: 1, src: 'url1', img: '/static/image/1.jpg' },
				{ id: 2, src: 'url2', img: '/static/image/2.jpg' },
				{ id: 3, src: 'url3', img: '/static/image/3.jpg' }
			],
			// 分类菜单
			categoryList: [
				{ id: 1, name: '办公', img: '/static/image/category/1.png' },
				{ id: 2, name: '家电', img: '/static/image/category/2.png' },
				{ id: 3, name: '服饰', img: '/static/image/category/3.png' },
				{ id: 4, name: '日用', img: '/static/image/category/4.png' },
				{ id: 5, name: '蔬果', img: '/static/image/category/5.png' },
				{ id: 6, name: '运动', img: '/static/image/category/6.png' },
				{ id: 7, name: '书籍', img: '/static/image/category/7.png' },
				{ id: 8, name: '文具', img: '/static/image/category/8.png' }
			],
			Promotion: [],
			//猜你喜欢列表
			productList: [
